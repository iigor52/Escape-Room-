...
STATION_DATA = {
    "station_number": 3,
    "station_name": "Escaping from the immunotherapy challenges - Station 3",
    "groups": {
        "group1": {
            "name": "Group 1",
            "next_station": 4,
...
def add_penalty_cooldown(seconds: int):
    ...
    # ostavljamo flag ako ga negdje koristiš, ali ga više nećemo koristiti za brisanje
    ...
    if not st.session_state.quiz_completed:
        ...
        with help_col1:
            ...
            if st.button(hint_button_text, use_container_width=True, key="hint_btn"):
                ...
                current_code_input = st.session_state.last_code_attempt or ""
