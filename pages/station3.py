...
def initialize_session():
    ...
    defaults = {
        ...
        'access_code': "",
        'penalty_triggered': False  # ✅ DODANO - sprječava dupliranje kazni
    }
...
def add_penalty_cooldown(seconds):
    ...
    # ✅ DODANO - resetiraj input polje kada se aplicira kazna
...
def main():
    ...
    if not st.session_state.quiz_completed:
        ...
        # ✅ IZMJENA - Live answer s boljom kontrolom kazni
        if st.session_state.answer_activated:
            ...
            if current_code_input and len(current_code_input) >= 1:
                ...
                if not first_wrong_found and len(code_upper) == 3:
                    ...
                    # ✅ IZMJENA - Dodaj kaznu samo jednom za točan odgovor
                    if not st.session_state.get('correct_answer_penalty_applied', False):
                        add_penalty_cooldown(60)
                        st.session_state.correct_answer_penalty_applied = True
        ...
        with col1:
            # ✅ IZMJENA - Resetiraj input ako je kazna aktivirana
            input_value = ""
            if is_penalty_active():
                if st.session_state.penalty_triggered:
                    # Resetiraj vrijednost i flag
