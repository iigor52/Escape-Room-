...
def initialize_session():
    ...
    defaults = {
        ...
        'total_penalties': 0,
        'penalty_triggered': False,     # reset input on new penalty
...
def main():
    ...
    if not st.session_state.quiz_completed:
        ...
        cooldown_active = is_penalty_active()
        ...
        with help_col1:
            ...
            if st.button(hint_button_text, use_container_width=True, key="hint_btn", disabled=cooldown_active):
        ...
        with help_col2:
            ...
            if st.button(answer_button_text, use_container_width=True, key="answer_btn", disabled=cooldown_active):
    ...
    # Auto-refresh only for penalty timer
